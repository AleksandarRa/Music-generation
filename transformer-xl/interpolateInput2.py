...
def saveValues(npz_filenames, npz_filenames2, song_len, cutted_song_len, acc_metric_sound, acc_metric_delta, loss_mse, loss_mae, alpha=0):
...
if __name__ == '__main__':
    ...
    # ============================================================
    # ============================================================
    npz_list = ['138.npz', '341.npz', '255.npz', '346.npz']
